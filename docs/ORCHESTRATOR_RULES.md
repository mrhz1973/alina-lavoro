...
Ultimo aggiornamento: 2026-05-10 — priorità **passo-passo** per l’orchestratore; sintesi stato stabile **V1.8.10** in fondo al file.
...
- Produzione Git/Apps Script: **V1.8.10** su **`main`**; tag stabile **`v1.8.10-stable`**; deploy clasp **`@21`** (ID `AKfycbz0_8bE92ATlKeb2oaOrhqOwrUgyiEnw977libqBH5Swkiv2LMwdDK0EbJyo-h7Zpjw6A`; deploy Windows: **Git Bash** se `npm run sync` fallisce — vedi `docs/sessions/2026-05-10-v1810-salary-reminder-snooze-24h-deploy.md`); snooze locale **24 ore** promemoria stipendio (`LS_SALARY_REMINDER_SNOOZE`, `shouldShowSalaryReminder_`) oltre a V1.8.9 (toggle anni **Mesi**), V1.8.4 (**`beb277a`**) e V1.8B (**`fc9ac43`**).
- Issue **#5** (arrotondamento Inizio/Fine a 5 minuti) **in produzione**; **test manuale utente su `/exec` @21:** **OK** (versione **1.8.10** — snooze stipendio, smoke; uso cellulare con URL **`/exec`**, non il link al foglio Google Sheet); **Xiaomi Redmi 9C NFC** (dispositivo target reale): **OK**. Ottimizzazioni future Mesi/Home/Note: **evolutive**, non urgenti.
- Tag utili per rollback: **`v1.8.9-stable`** (deploy **`@20`**), **`v1.8.8-stable`** (deploy **`@19`** — bug toggle anni), **`v1.8.7-stable`** (deploy **`@18`**), **`v1.8.6-stable`** (deploy **`@17`**), **`v1.8.5-stable`** (deploy **`@15`**), **`v1.8.4-stable`** (deploy **`@14`**), **`v1.8.3-stable`** (deploy **`@12`**), **`v1.8.2-stable`** (deploy **`@10`**), **`v1.8.1-stable`**, **`v1.8.0-stable`**, **`v1.6.2-stable`**, **`v1.5-stable`** (storico).
