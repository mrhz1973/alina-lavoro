...
- Issue **#5** (arrotondamento Inizio/Fine a 5 minuti) **in produzione**; **test manuale utente su `/exec` @21:** **OK** (versione **1.8.10** — snooze stipendio, smoke; uso cellulare con URL **`/exec`**, non il link al foglio Google Sheet).
