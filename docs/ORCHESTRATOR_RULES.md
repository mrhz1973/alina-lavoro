...
Ultimo aggiornamento: 2026-05-10 — priorità **passo-passo** per l’orchestratore; sintesi stato stabile **V1.9.2** (deploy **`@24`**, test **`/exec` da fare**) in fondo al file.
...
- Issue **#5** **in produzione**; **test manuale utente su `/exec` @24:** **da fare** (Dettaglio mese nuovo layout + smoke). **V1.9.1** su **`/exec` @23:** **OK** (2026-05-10). **Xiaomi Redmi 9C NFC:** test **`@24`** consigliato. Banner GAS: **limitazione piattaforma** — `docs/sessions/2026-05-10-v190-month-detail-mvp-deploy.md`.
