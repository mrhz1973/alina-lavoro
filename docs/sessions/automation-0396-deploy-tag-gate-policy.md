# Automation Session — 0396-deploy-tag-gate-policy.md
...
- Task name: 0396-deploy-tag-gate-policy.md
- Task path: docs/tasks/queue/0396-deploy-tag-gate-policy.md
- Task SHA: ce190b4fbbf1a080151490efbad8c9c15dd1fb77
- Type: docs
- Priority: high
- Deploy policy: no
...
- Cursor prompt path: docs/tasks/processing/0396-deploy-tag-gate-policy-cursor-prompt.md
- Session path: docs/sessions/automation-0396-deploy-tag-gate-policy.md
...
docs/tasks/processing/0396-deploy-tag-gate-policy-cursor-prompt.md
```
