# Automation Session — 0119-vps-runner-setup-preflight-docs-only.md
...
- Task name: 0119-vps-runner-setup-preflight-docs-only.md
- Task path: docs/tasks/queue/0119-vps-runner-setup-preflight-docs-only.md
- Task SHA: 1785b5ba98119d6dee60ed63471be0f254548000
- Type: docs-only
- Priority: normal
- Deploy policy: no
...
- Cursor prompt path: docs/tasks/processing/0119-vps-runner-setup-preflight-docs-only-cursor-prompt.md
- Session path: docs/sessions/automation-0119-vps-runner-setup-preflight-docs-only.md
...
docs/tasks/processing/0119-vps-runner-setup-preflight-docs-only-cursor-prompt.md
```
