# Automation Session — 0393-claude-full-autonomy-policy.md
...
- Task name: 0393-claude-full-autonomy-policy.md
- Task path: docs/tasks/queue/0393-claude-full-autonomy-policy.md
- Task SHA: 7e0c52d889bf97c1ed93106082b62dbd0440e1c0
- Type: docs
- Priority: high
- Deploy policy: no
...
- Cursor prompt path: docs/tasks/processing/0393-claude-full-autonomy-policy-cursor-prompt.md
- Session path: docs/sessions/automation-0393-claude-full-autonomy-policy.md
...
docs/tasks/processing/0393-claude-full-autonomy-policy-cursor-prompt.md
```
