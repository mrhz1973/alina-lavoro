# Automation Session — 0392-v220-stable-tag.md
...
- Task name: 0392-v220-stable-tag.md
- Task path: docs/tasks/queue/0392-v220-stable-tag.md
- Task SHA: 67e4d3c0a762069ceb222bcba05c207b5ac3673a
- Type: release
- Priority: high
- Deploy policy: no
...
- Cursor prompt path: docs/tasks/processing/0392-v220-stable-tag-cursor-prompt.md
- Session path: docs/sessions/automation-0392-v220-stable-tag.md
...
docs/tasks/processing/0392-v220-stable-tag-cursor-prompt.md
```
