# Automation Session — 0391-v220-post-deploy-test.md
...
- Task name: 0391-v220-post-deploy-test.md
- Task path: docs/tasks/queue/0391-v220-post-deploy-test.md
- Task SHA: d0eb247b8dde7fcee3f39cb9fe26d06970c4a292
- Type: manual-test
- Priority: high
- Deploy policy: no
...
- Cursor prompt path: docs/tasks/processing/0391-v220-post-deploy-test-cursor-prompt.md
- Session path: docs/sessions/automation-0391-v220-post-deploy-test.md
...
docs/tasks/processing/0391-v220-post-deploy-test-cursor-prompt.md
```
