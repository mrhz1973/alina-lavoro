# Automation Session — 0107-n8n-queue-reader-skip-failed-runtime-validation.md
...
- Task name: 0107-n8n-queue-reader-skip-failed-runtime-validation.md
- Task path: docs/tasks/queue/0107-n8n-queue-reader-skip-failed-runtime-validation.md
- Task SHA: 9d93cbd22be442ecd3ade9fb0d16167e1b30ccdf
...
- Cursor prompt path: docs/tasks/processing/0107-n8n-queue-reader-skip-failed-runtime-validation-cursor-prompt.md
- Session path: docs/sessions/automation-0107-n8n-queue-reader-skip-failed-runtime-validation.md
...
docs/tasks/processing/0107-n8n-queue-reader-skip-failed-runtime-validation-cursor-prompt.md
```
