# Automation Session — 0394-claude-permission-config-hardening.md
...
- Task name: 0394-claude-permission-config-hardening.md
- Task path: docs/tasks/queue/0394-claude-permission-config-hardening.md
- Task SHA: 497208cd0181f14cd6f34e603f6d49b931f1fc41
- Type: docs
- Priority: high
- Deploy policy: no
...
- Cursor prompt path: docs/tasks/processing/0394-claude-permission-config-hardening-cursor-prompt.md
- Session path: docs/sessions/automation-0394-claude-permission-config-hardening.md
...
docs/tasks/processing/0394-claude-permission-config-hardening-cursor-prompt.md
```
