# Automation Session — 0367-v211-stable-tag.md
...
- Task name: 0367-v211-stable-tag.md
- Task path: docs/tasks/queue/0367-v211-stable-tag.md
- Task SHA: b517fd528c70483fd16eb18adc554926c940aa18
- Type: release / docs
- Priority: high
...
- Cursor prompt path: docs/tasks/processing/0367-v211-stable-tag-cursor-prompt.md
- Session path: docs/sessions/automation-0367-v211-stable-tag.md
...
docs/tasks/processing/0367-v211-stable-tag-cursor-prompt.md
```
