# Automation Session — 0399-v221-month-detail-label-cleanup.md
...
- Task name: 0399-v221-month-detail-label-cleanup.md
- Task path: docs/tasks/queue/0399-v221-month-detail-label-cleanup.md
- Task SHA: 5ebdce4dbbf66e29a074288e8caa3c947ec7b264
...
- Cursor prompt path: docs/tasks/processing/0399-v221-month-detail-label-cleanup-cursor-prompt.md
- Session path: docs/sessions/automation-0399-v221-month-detail-label-cleanup.md
...
docs/tasks/processing/0399-v221-month-detail-label-cleanup-cursor-prompt.md
```
