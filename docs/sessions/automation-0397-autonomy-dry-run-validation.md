# Automation Session — 0397-autonomy-dry-run-validation.md
...
- Task name: 0397-autonomy-dry-run-validation.md
- Task path: docs/tasks/queue/0397-autonomy-dry-run-validation.md
- Task SHA: 7fdef6a4054ad51aeb239e642006a53ac4ab4a61
- Type: validation
- Priority: normal
- Deploy policy: no
...
- Cursor prompt path: docs/tasks/processing/0397-autonomy-dry-run-validation-cursor-prompt.md
- Session path: docs/sessions/automation-0397-autonomy-dry-run-validation.md
...
docs/tasks/processing/0397-autonomy-dry-run-validation-cursor-prompt.md
```
