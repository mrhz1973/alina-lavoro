# Automation Session — 0005-test-n8n-queue-reader-true-branch.md
...
- Task name: 0005-test-n8n-queue-reader-true-branch.md
- Task path: docs/tasks/queue/0005-test-n8n-queue-reader-true-branch.md
- Task SHA: 2aa15d6e98a3c0b1f35808dc9de6dc5b68bb2b10
- Type: test
- Priority: low
- Deploy policy: no
...
- Cursor prompt path: docs/tasks/processing/0005-test-n8n-queue-reader-true-branch-cursor-prompt.md
- Session path: docs/sessions/automation-0005-test-n8n-queue-reader-true-branch.md
...
docs/tasks/processing/0005-test-n8n-queue-reader-true-branch-cursor-prompt.md
```
