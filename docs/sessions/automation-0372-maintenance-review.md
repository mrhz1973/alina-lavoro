# Automation Session — 0372-maintenance-review.md
...
- Task name: 0372-maintenance-review.md
- Task path: docs/tasks/queue/0372-maintenance-review.md
- Task SHA: 7d16bb99b71a8f80fd4e4b9fe7beed8e80390206
- Type: review / docs
- Priority: low
- Deploy policy: no
- Deploy policy: 
...
- Cursor prompt path: docs/tasks/processing/0372-maintenance-review-cursor-prompt.md
- Session path: docs/sessions/automation-0372-maintenance-review.md
...
docs/tasks/processing/0372-maintenance-review-cursor-prompt.md
```
