# Automation Session — 0113-n8n-queue-reader-subworkflow-prerequisite.md
...
- Task name: 0113-n8n-queue-reader-subworkflow-prerequisite.md
- Task path: docs/tasks/queue/0113-n8n-queue-reader-subworkflow-prerequisite.md
- Task SHA: c6322722776ffbb7d8731258930b01407f9adb15
...
- Cursor prompt path: docs/tasks/processing/0113-n8n-queue-reader-subworkflow-prerequisite-cursor-prompt.md
- Session path: docs/sessions/automation-0113-n8n-queue-reader-subworkflow-prerequisite.md
...
docs/tasks/processing/0113-n8n-queue-reader-subworkflow-prerequisite-cursor-prompt.md
```
