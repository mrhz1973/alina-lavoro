# Automation Session — 0139-auto-aggio-prompt-generation-handshake-design.md
...
- Task name: 0139-auto-aggio-prompt-generation-handshake-design.md
- Task path: docs/tasks/queue/0139-auto-aggio-prompt-generation-handshake-design.md
- Task SHA: 818f25150ec550b7adb480cd26e0e6c6f1185d42
- Type: 
- Priority: 
- Deploy policy: 
...
- Cursor prompt path: docs/tasks/processing/0139-auto-aggio-prompt-generation-handshake-design-cursor-prompt.md
- Session path: docs/sessions/automation-0139-auto-aggio-prompt-generation-handshake-design.md
...
docs/tasks/processing/0139-auto-aggio-prompt-generation-handshake-design-cursor-prompt.md
```
