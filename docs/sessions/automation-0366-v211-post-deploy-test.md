# Automation Session — 0366-v211-post-deploy-test.md
...
- Task name: 0366-v211-post-deploy-test.md
- Task path: docs/tasks/queue/0366-v211-post-deploy-test.md
- Task SHA: d53a68b62c0e34917c7d7b390a24386a4389f6af
...
- Cursor prompt path: docs/tasks/processing/0366-v211-post-deploy-test-cursor-prompt.md
- Session path: docs/sessions/automation-0366-v211-post-deploy-test.md
...
docs/tasks/processing/0366-v211-post-deploy-test-cursor-prompt.md
```
