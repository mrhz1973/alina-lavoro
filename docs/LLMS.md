...
| LLM Wiki (this layer) | ✅ Active — **V3.1** (batch 0232–0266, 2026-05-14): Task-ID Guard, Prompt Routing, Budget Policy, Template Pack Index, Delta-based prompt example, Compact task creation workflow, Compact implementer prompt workflow, Multi-step batch planning rules, Compact workflow cookbook; **V3.1 Enforcement Checklist + Prompt Size Guard** (batch 0254–0258) — `docs/wiki/v31-enforcement-checklist.md`; **AGENTS.md pointer-only + 6–8 batch priority** (batch 0259–0266) — `AGENTS.md` replaced; batch size max 8 (prefer 6–8) propagated project-wide; implementer templates in `docs/tasks/templates/` | `docs/wiki/` |
