...
| LLM Wiki (this layer) | ✅ Active — **V3.1** (task 0232, 2026-05-14): Context Router (`docs/wiki/prompt-routing.md`), Task-ID Guard (`docs/wiki/task-id-preflight.md`), Budget Policy (`docs/wiki/context-budget-policy.md`), Template Pack Index (`docs/wiki/template-pack-index.md`); implementer templates in `docs/tasks/templates/` | `docs/wiki/` |
