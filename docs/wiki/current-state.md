...
**Derived memory (Level 2) — last updated: 2026-05-17 (task 0427)**
**Posture:** V2.2.0 + 0406–0427 deployed @54 (UI-only Mesi cleanup, 2026-05-17). URL unchanged. APP_BUILD='0427'. External sheet import NOT live. Manual phone test pending → stable tag pending.
...
| Last test | **PASS** (0366, V2.1.1) — V2.2.0 @54 phone test pending |
| Scope | **V2.2.0 · no-login · 0406–0427 deployed @54 · URL unchanged · import NOT live · phone test pending · stable tag pending** |
...
| Queue | **0391** (post-deploy phone test for @54), **0392** (stable tag). Next gate: manual phone test on @54. |
...
| Version | Tag | Deploy |
|---|---|---|
| V2.2.0 + 0406–0427 | `v2.2.0-stable` (pending phone test) | **@54 UI-only patch (current production — same ID/URL)** |
