...
**Derived memory (Level 2) — last updated: 2026-05-17 (task 0421)**
**Posture:** V2.2.0 + 0406–0420 deployed @48 (fix redeploy 2026-05-17). URL unchanged. Manual phone test pending → stable tag pending.
...
| Field | Value |
|---|---|
| Source version | **V2.2.0 + 0406–0420** (deployed @48) |
| Production version | **V2.2.0 + 0406–0420** (fix redeploy 2026-05-17 @48, URL unchanged) |
| Tag | **`v2.1.1-stable`** (last stable; v2.2.0-stable pending phone test) |
| Branch | **main** |
| Apps Script | **@48** (fix redeploy 2026-05-17; ID: AKfycbxtG6_wflGYGuqWFjkVsrgGSWlQzcRvuR13VKsgNwsnHXbXSbpgPlS8UMuXDHM8FtHxRQ; URL unchanged — mismatch fix task 0421) |
| Last test | **PASS** (0366, V2.1.1) — V2.2.0 @48 phone test pending |
| Scope | **V2.2.0 · no-login · 0406–0420 deployed @48 · URL unchanged · phone test pending · stable tag pending** |
...
| Queue | **0391** (post-deploy phone test for @48), **0392** (stable tag). Next gate: manual phone test on @48. |
...
| Version | Tag | Deploy |
|---|---|---|
| V2.2.0 + 0406–0420 | `v2.2.0-stable` (pending phone test) | @48 fix (same ID/URL as @47/@45/@43/@41/@39/@37 — mismatch fix 0421) |
| V2.2.0 + 0406–0419 | — | @45 |
| V2.2.0 + 0406–0418 | — | @43 |
| V2.2.0 + 0406–0417 | — | @41 |
| V2.2.0 + 0406–0416 | — | @39 |
