...
**Derived memory (Level 2) — last updated: 2026-05-14 (task 0266)**
...
| INBOX decided count | 21 |
| D-0259-A | **Decided = 1** (batch 0259–0266, 2026-05-14) — AGENTS.md pointer-only authorized; `AGENTS.md` replaced with pointer-only version (~38 lines) |
