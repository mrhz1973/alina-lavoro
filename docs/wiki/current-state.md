...
**Derived memory (Level 2) — last updated: 2026-05-17 (task 0417)**
**Posture:** V2.2.0 + 0406–0417 deployed @41 (2026-05-17). URL unchanged (same deployment ID as @37/@39). Manual phone test pending → stable tag pending.
...
| Field | Value |
|---|---|
| Source version | **V2.2.0 + 0406–0417** (deployed @41) |
| Production version | **V2.2.0 + 0406–0417** (deployed 2026-05-17 @41, URL unchanged) |
| Tag | **`v2.1.1-stable`** (last stable; v2.2.0-stable pending phone test) |
| Branch | **main** |
| Apps Script | **@41** (2026-05-17; ID: AKfycbxtG6_wflGYGuqWFjkVsrgGSWlQzcRvuR13VKsgNwsnHXbXSbpgPlS8UMuXDHM8FtHxRQ; URL unchanged) |
| Last test | **PASS** (0366, V2.1.1) — V2.2.0 @41 phone test pending |
| Scope | **V2.2.0 · no-login · 0406–0417 deployed @41 · URL unchanged · phone test pending · stable tag pending** |
...
| Queue | **0391** (post-deploy phone test for @41), **0392** (stable tag). Next gate: manual phone test on @41. |
...
| Version | Tag | Deploy |
|---|---|---|
| V2.2.0 + 0406–0417 | `v2.2.0-stable` (pending phone test) | @41 (URL same as @37/@39) |
| V2.2.0 + 0406–0416 | — | @39 |
| V2.2.0 + 0406–0414 | — | @37 |
| V2.2.0 + 0406 fix | — | @35 |
| V2.2.0 patched | — | @33 |
