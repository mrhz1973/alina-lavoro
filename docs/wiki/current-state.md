...
| Next planned | 0134 — Windows Ollama Local Preflight (queued, docs-only preparation completed 2026-05-13) — runtime execution requires explicit manual gate; user-reported local state: Ollama installed on Windows (0.23.2), qwen3:14b present; future gate is validation/documentation, not initial installation; target: Windows workstation (Ryzen 9 3900X / RTX 3060 12 GB); Mac M2 opzione secondaria |
