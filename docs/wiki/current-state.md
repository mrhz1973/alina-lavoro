...
**Posture:** V2.2.0 + 0406–0419 deployed @45 (2026-05-17). URL unchanged (redeploy in place). Manual phone test pending → stable tag pending.
...
| Field | Value |
|---|---|
| Source version | **V2.2.0 + 0406–0419** (deployed @45) |
...
| Branch | **main** |
| Apps Script | **@45** (2026-05-17; ID: AKfycbxtG6_wflGYGuqWFjkVsrgGSWlQzcRvuR13VKsgNwsnHXbXSbpgPlS8UMuXDHM8FtHxRQ; URL unchanged — redeploy in place) |
| Last test | **PASS** (0366, V2.1.1) — V2.2.0 @45 phone test pending |
| Scope | **V2.2.0 · no-login · 0406–0419 deployed @45 · URL unchanged · phone test pending · stable tag pending** |
...
| Queue | **0391** (post-deploy phone test for @45), **0392** (stable tag). Next gate: manual phone test on @45. |
...
| Version | Tag | Deploy |
|---|---|---|
| V2.2.0 + 0406–0419 | `v2.2.0-stable` (pending phone test) | @45 (URL same as @43/@41/@39/@37 — redeploy in place) |
| V2.2.0 + 0406–0418 | — | @43 |
| V2.2.0 + 0406–0417 | — | @41 |
| V2.2.0 + 0406–0416 | — | @39 |
| V2.2.0 + 0406–0414 | — | @37 |
