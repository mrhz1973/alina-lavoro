...
**Derived memory (Level 2) — last updated: 2026-05-15 (task 0304)**
...
| Item | Value |
|---|---|
| Last completed | **0304 — minimal branch policy for dual CLI** (2026-05-15): dual-CLI design §20; main remains source of truth; dual CLI LATER/GATED. |
