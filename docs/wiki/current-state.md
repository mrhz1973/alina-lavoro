...
**Derived memory (Level 2) — last updated: 2026-05-17 (task 0422)**
**Posture:** V2.2.0 + 0406–0420 deployed @49 (corrected push + redeploy 2026-05-17). URL unchanged. Remote verified APP_BUILD='0420'. Manual phone test pending → stable tag pending.
...
| Field | Value |
|---|---|
| Source version | **V2.2.0 + 0406–0420** (deployed @49) |
| Production version | **V2.2.0 + 0406–0420** (corrected push 2026-05-17 @49, URL unchanged) |
| Tag | **`v2.1.1-stable`** (last stable; v2.2.0-stable pending phone test) |
| Branch | **main** |
| Apps Script | **@49** (corrected push 2026-05-17; ID: AKfycbxtG6_wflGYGuqWFjkVsrgGSWlQzcRvuR13VKsgNwsnHXbXSbpgPlS8UMuXDHM8FtHxRQ; URL unchanged — root cause fix task 0422) |
| Last test | **PASS** (0366, V2.1.1) — V2.2.0 @49 phone test pending |
| Scope | **V2.2.0 · no-login · 0406–0420 deployed @49 · URL unchanged · phone test pending · stable tag pending** |
...
| Item | Value |
|---|---|
| Last completed | **0422** (root cause fix — corrected push + redeploy @49, 2026-05-17) |
...
| Queue | **0391** (post-deploy phone test for @49), **0392** (stable tag). Next gate: manual phone test on @49. |
...
| Version | Tag | Deploy |
|---|---|---|
| V2.2.0 + 0406–0420 | `v2.2.0-stable` (pending phone test) | @49 corrected push (same ID/URL — root cause fix 0422) |
| V2.2.0 + 0406–0419 | — | @45 |
| V2.2.0 + 0406–0418 | — | @43 |
| V2.2.0 + 0406–0417 | — | @41 |
| V2.2.0 + 0406–0416 | — | @39 |
