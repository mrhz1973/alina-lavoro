...
- Prossimo passo operativo: task 0114 (futuro) — attivare il watcher con Schedule Trigger ogni 5 minuti (gate manuale separato, test ciclo has_task:false e has_task:true). Runner documentale automatico (Claude Code CLI / Cursor CLI) resta fuori scope e futuro.
