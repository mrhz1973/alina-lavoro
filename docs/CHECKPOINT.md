...
- Prossimo passo operativo: task 0113 (futuro) — runner documentale automatico (Claude Code CLI / Cursor CLI sul VPS); gate manuale obbligatorio prima del primo run non supervisionato.
