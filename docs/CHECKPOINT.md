...
- Prossimo passo automazione: vincolare binding n8n a `127.0.0.1` (task separato) oppure evoluzione watcher/runner oppure tornare all'app Alina — decisione orchestratore.
