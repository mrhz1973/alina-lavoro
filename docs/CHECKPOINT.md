...
Ultimo aggiornamento: 2026-05-17 (tasks 0391+0392 stable close) — V2.2.0 STABLE. Tag v2.2.0-stable creato. Phone test PASS su @54 / build 0427. Session: `docs/sessions/2026-05-17-v220-stable-close.md`. Canonical Level-2 memory is `docs/LLMS.md` + `docs/wiki/current-state.md`; entries below preserved from 2026-05-13 compression and superseded by the wiki for state-reading.
