...
**Task 0127 creato** (tipo `low-touch-loop-docs-only`, 2026-05-12): Decision Packet Format in queue; inaugura fase low-touch loop per ridurre micro-interazioni umane (criterio permanente: "quante micro-interazioni umane elimina?"); definizione formato Decision Packet con campo kind (alina-feature/automation/infra/meta); NON autorizza runtime, installazioni, login, API key, VPS, n8n, GitHub Actions, runner automatico, app, deploy/tag/rollback; criterio permanente aggiunto a docs/ORCHESTRATOR_RULES.md; task `docs/tasks/queue/0127-decision-packet-format.md`.

1. Prossimo passo: attendere che n8n queue reader generi processing/sessione per 0127 oppure verificare con aggio; restare su modalità manuale-supervisionata (0124 confermata da 0126). App Alina V1.9.2 stabile e non toccata.
