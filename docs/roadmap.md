...
**Telegram Mode A — stato corrente (tasks 0170–0176, 2026-05-13):** notifica manuale validata (test OK, task 0170). Schedule activation deferred: D-0171-A = 3. Runbook/idempotency hardening doc created (task 0172): `docs/automation/telegram-notifier-runbook-idempotency-hardening.md`. D-0173-A **pending** — no decision made (task 0173). Neutral handoff doc (task 0176): `docs/automation/telegram-schedule-activation-pending-gate-handoff.md`. Batch-size policy formalized (task 0175): docs-only ≤ 6; docs+DP ≤ 5; docs+design ≤ 4; runtime = 1 step. Next: resolve D-0173-A explicitly. Workflow inactive. No Schedule Trigger. No token/chat id in repo. Auto-follow policy: future consideration only.
