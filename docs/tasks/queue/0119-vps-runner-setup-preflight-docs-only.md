...
- ID: 0119-vps-runner-setup-preflight-docs-only
...
Le decision gate della Fase 3 runner documentale sono state approvate (task 0118,
2026-05-12; documento: `docs/automation/runner-phase3-gate-decision.md`).

Il prossimo passo indicato dal gate decision è un task di **preflight puro**: design
teorico, checklist, stime di costo e rischi — senza installare nulla sul VPS, senza
configurare API key, senza modificare n8n runtime.

Stato VPS noto da task precedenti (0109/0110):
- Ubuntu 24.04.4 LTS, kernel 6.8.0-111-generic.
- n8n in Docker (`root-n8n-1`), porta 5678, binding `127.0.0.1:5678`.
- SSH accessibile per manutenzione.
- npm disponibile (verificare versione nel documento di output).
...
- `docs/automation/vps-runner-setup-preflight.md` (da creare)
- `docs/PROJECT_STATE.md`
- `docs/CHECKPOINT.md`
- `docs/tasks/done/0119-vps-runner-setup-preflight-docs-only.md`
- `docs/sessions/` (opzionale)
...
1. Esiste `docs/automation/vps-runner-setup-preflight.md` con le dieci sezioni richieste.
...
4. Done marker in `docs/tasks/done/0119-vps-runner-setup-preflight-docs-only.md`.
