...
**Status:** active reference document — **updated batch 0188–0190 (2026-05-14): D-0187-A = 1 decided — duplicate-skip validation gate open for exactly one manual run; runtime handoff created; idempotency/state-store implementation complete; Data Table `alina_telegram_notifier_state` created; one send/write test succeeded; no Schedule Trigger; no token/chat id in repo**
