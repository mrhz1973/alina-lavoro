...
- **Dispositivo target reale:** **Xiaomi Redmi 9C NFC** è il riferimento hardware principale per i test su cellulare; **V1.9.1** / **`@23`**: test manuale utente su **`/exec`** — **OK** (Stipendio / Dettaglio / anni / smoke). Eventuali ottimizzazioni future su **Mesi** / **Home** / **Note** restano **evolutive**, non urgenti.
...
2. Evoluzione **Dettaglio mese** più **grafico** / **visivo** — backlog (`docs/roadmap.md`).
