...
1. Completare **task 0102** (docs-only, Claude Code runner) — aggiornamento stato post-PR #7.
2. Eseguire **task 0101** (n8n-docs) — aggiornare n8n per leggere template dal repo (richiede lavoro manuale n8n).
3. Lavoro nuovo su **`main`** dopo `git pull origin main`.
